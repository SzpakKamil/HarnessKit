...
public nonisolated func processScreenshotIOS(image: NSImage, config: ScreenshotConfig, screenshot: Screenshot) throws -> NSImage {
    guard let bezelCase = resolveBezel(from: config.phoneBezel, for: screenshot, bezelType: PhoneBezel.self) else {
