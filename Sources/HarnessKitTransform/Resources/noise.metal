...
//  ForkedGlur
//
//  Copied verbatim from upstream Glur. Noise is a per-pixel post-pass
//  on the visible content and has no sampling of neighbors, so there's
//  nothing to patch for overflow behavior.
//
